...
global_constraints = {
    ...
    'B1':  "abs(freqs[i] + alpha[i] - freqs[j]) > d['A1']",
    'B2i': "abs(freqs[i] + alpha[i] - freqs[j] - alpha[j]) > d['A2i']",
    'B2j': "abs(freqs[j] + alpha[i] - freqs[i] - alpha[i]) > d['A2j']",
    'B3i': "abs(freqs[i] + alpha[i] - freqs[j] - 2*alpha[j]) > d['A3i']",
    'B3j': "abs(freqs[j] + alpha[i] - freqs[i] - 2*alpha[i]) > d['A3j']",
...
global_idx_list = {
    ...
    'B1':  "G.oriented_edge_index",
    'B2i':  "G.oriented_edge_index",
    'B2j':  "G.oriented_edge_index",
    'B3j':  "G.oriented_edge_index",
    'B3i':  "G.oriented_edge_index",
